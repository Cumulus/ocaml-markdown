...
(* OASIS_START *)
(* DO NOT EDIT (digest: b9420d53d4cdf069ab248112893048b3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights =
            ["(C) 2009 Mauricio Fernandez"; "(C) 2010 Sylvain Le Gall"];
          maintainers = ["Sylvain Le Gall <sylvain@le-gall.net>"];
          authors = ["Mauricio Fernandez"; "Sylvain Le Gall"];
          homepage =
            Some "http://forge.ocamlcore.org/projects/ocaml-markdown/";
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["MarkdownHTML"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "markdown";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Executable
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "FQ\132\002d\218\175\152\015c3\027\190t}#";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
